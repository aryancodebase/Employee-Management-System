const AllTask = () => {
  ...
  return (
    <div className="w-full overflow-x-auto">
      <div
        className="flex flex-col gap-3 min-w-[500px] h-[70vh] overflow-y-auto"
        id="allTask"
      >
        {/* Header */}
        <div className="p-4 grid grid-cols-[2fr_1fr_1fr_1fr] rounded-lg bg-gray-900 sticky top-0 z-10 font-semibold text-sm sm:text-base">
        ...
        {usersData.map((user) => (
          <div
            key={user.id}
            className="p-4 grid grid-cols-[2fr_1fr_1fr_1fr] rounded-lg border border-gray-700 text-sm sm:text-base"
          >
